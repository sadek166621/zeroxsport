                                    ...
                                    <tbody>
                                        @if (count($orders) > 0)
                                            @foreach ($orders as $key => $order)
                                                <tr>
                                                    <td>{{ $key + 1 + ($orders->currentPage() - 1) * $orders->perPage() }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        @php
                                                            $statuses = [
                                                                ...
                                                                2 => ['text' => 'Processing', 'class' => 'bg-warning'],
                                                                3 => ['text' => 'Shipped', 'class' => 'bg-primary'],
                                                                4 => ['text' => 'Delivered', 'class' => 'bg-success'],
                                                                5 => ['text' => 'Canceled', 'class' => 'bg-danger'],
                                                                6 => ['text' => 'Returned', 'class' => 'bg-dark'],
                                                                7 => ['text' => 'Refunded', 'class' => 'bg-success'],
                                                                8 => ['text' => 'Failed', 'class' => 'bg-danger'],
                                                            ];

                                                            $status = $statuses[$order->delivery_status] ?? [
                                                                'text' => 'Unknown',
                                                                'class' => 'bg-secondary',
                                                            ];
                                                        @endphp
                                                    ...
                                                    @php
                                                        switch ($order->payment_method) {
                                                            case 'bkash':
                                                                $color = 'bg-success'; // custom class or bg-danger
                                                                break;
                                                            case 'nagad':
                                                                $color = 'bg-warning';
                                                                break;
