...
@section('admin')
    <section class="content-main">
        <div class="content-header">
            ...
            <div>
                <a type="button" title="Customer Create" class="btn btn-primary d-none" style="margin-right: 20px"
                        ...
                        <tbody>
                            @foreach ($customers as $key => $customer)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('reset-password', $customer->id) }}"
                            ...
                            <div class="col-lg-6">
                                <div class="mb-1">
                                    <label class="col-form-label" style="font-weight: bold;">Phone: <span
                                            class="text-danger">*</span></label>
                                    <input type="text" placeholder="Write Phone" id="phone" name="phone" required
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-1">
                                    <label class="col-form-label" style="font-weight: bold;">Address: <span
                                            class="text-danger">*</span></label>
                                    <input type="text" placeholder="Write Address" id="address" name="address" required
                                        class="form-control">
                                </div>
                            </div>
                            <div class="mb-1 mt-2">
