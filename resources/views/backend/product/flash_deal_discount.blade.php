  ...
  <tbody>
    ...
    @foreach ($product_ids as $key => $id)
        @php
            ...
            $totalBuyingPrice += $product->purchase_price; // Add the regular price to the total
        @endphp
        <tr>
            <td>
    ...
    <!-- Display the total regular price after the loop -->
    {{-- <tr>
        <td colspan="2"></td>
        <td>Total Regular Price:</td>
        <td colspan="2">{{ $totalRegularPrice }}</td>
    </tr> --}}
    @php
