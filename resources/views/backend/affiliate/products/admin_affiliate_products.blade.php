...
<section class="content-main">
    <div class="content-header mx-2">
        <div class="col-md-10">
            <h2 class="content-title">Admin Affiliate Product List</h2>
            <strong style="font-weight: bold" class="text-dark">{{ count($products) }} Products Found</strong>
        </div>
       {{-- <div class="col-md-4">
            <a href="{{ route('product.affiliate.on') }}" title="Affiliate Status On" class="btn btn-info">ON all Products</a>
            <a href="{{ route('product.affiliate.off') }}" title="Affiliate Status Off" class="btn btn-danger">OFF all Products</a>
        </div> --}}
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" style="margin: 50% 0">
                                    <a class="btn btn-primary" href="{{ route('product.edit',$item->id) }}" title="Edit Info" style="padding:12px; margin-right: 5px; border-radius: 5px"><i class="fa fa-pencil"></i></a>
