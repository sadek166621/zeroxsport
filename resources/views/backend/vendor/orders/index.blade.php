                                ...
                                <div class="col-md-2 mt-2">
                                    ...
                                    <div class="custom_select">
                                        <select
                                            ...
                                            <option value="0" @if ($delivery_status == 0) selected @endif>Pending
                                            </option>
                                            <option value="1" @if ($delivery_status == 1) selected @endif>
                                                Confirmed</option>
                                            <option value="2" @if ($delivery_status == 2) selected @endif>
                                                Processing</option>
                                            <option value="3" @if ($delivery_status == 3) selected @endif>Shipped
                                            </option>
                                            <option value="4" @if ($delivery_status == 4) selected @endif>
                                                Delivered</option>
                                            <option value="5" @if ($delivery_status == 5) selected @endif>
                                                Canceled</option>
                                            <option value="6" @if ($delivery_status == 6) selected @endif>
                                                Returned</option>
                                            <option value="7" @if ($delivery_status == 7) selected @endif>
                                                Refunded</option>
                                            <option value="8" @if ($delivery_status == 8) selected @endif>Failed
                                            </option>
                                        </select>
                                    </div>
                                </div>
