...
@section('content')
    <style>
        ...
        .filter-btn {
            width: 100%;
            padding: 0.9rem;
            background: linear-gradient(135deg, #f09220 0%, #059669 100%);
            color: white;
            border: none;
            border-radius: 6px;
            font-weight: 600;
        ...
        .product-image {
            ...
            width: 100%;
            height: 200px;
            background: linear-gradient(135deg, #f09220, #10B981);
            display: flex;
            align-items: center;
        ...
        .product-badge {
            ...
            top: 12px;
            right: 12px;
            background: linear-gradient(135deg, #f09220, #059669);
            color: white;
            padding: 8px 12px;
            border-radius: 8px;
            font-weight: bold;
