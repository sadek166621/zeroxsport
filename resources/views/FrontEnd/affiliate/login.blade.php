                ...
                <div class="col-lg-10">
                    <div class="row g-0 shadow-lg rounded-4 overflow-hidden">
                        ...
                        <div class="col-md-6 d-none d-md-flex align-items-center justify-content-center"
                            style="background: #393f81;">
                            <img src="{{ asset('FrontEnd/assect/img/affiliate.png') }}" alt="Affiliate" class="img-fluid"
                        ...
                        <div class="col-md-6 bg-white p-4">
                            <div class="card border-0 bg-transparent p-0">
                                <div class="text-center mb-4">
                                    <a href="/">
                                        <img src="{{ asset(get_setting('site_logo')->value) }}" class="mb-3"
                                            style="max-width: 120px;" alt="Logo" />
                                    </a>
                                    <h2 class="fw-bold mb-2" style="letter-spacing: 1px; color: #393f81;">Affiliate Login
                                    </h2>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <button type="button" id="toggle-password"
                                            class="btn btn-sm btn-link position-absolute  translate-middle-y pe-2"
                                            style="top:65px; right:0; z-index:10;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        @if (Route::has('affiliate.forgot.password'))
                                            <a class="fw-bold" style="color: red !important;"
                                                href="{{ route('affiliate.forgot.password') }}">
                                                Forgot Password?
                                            </a>
                                        @endif
                                    </div>
                                ...
                                <div class="mt-4 text-center">
                                    <p class="mb-0" style="color: #393f81;">
                                        ...
                                        <a href="{{ route('register.affiliate') }}" class="fw-bold"
                                            style="color: #EF8848 !important;">
                                            Register now
                                        </a>
                                    </p>
                                </div>
