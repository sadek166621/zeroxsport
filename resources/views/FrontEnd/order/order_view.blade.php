        ...
        <div class="" style="display: flex; justify-content: space-between; padding: 8px 0px;">
            ...
            <div class="">
                @if ($user->role == '3' || $user->role == '4')
                    <a style="color: green; font-weight: 900; font-size: 16px;" href="{{ route('home') }}"><i
                            class="fa-solid fa-backward"></i> Back to
                        Home</a>
                @endif
                @if ($user->role == '5')
                    <a style="color: green; font-weight: 900; font-size: 16px;"
                        href="{{ route('wholeseller.dashboard') }}"><i class="fa-solid fa-backward"></i> Back to
                        Home</a>
                @endif
            </div>
                        ...
                        <div class="tm_table tm_style1">
                            <div class="tm_border tm_accent_border_20">
                                <div class="tm_table_responsive">
                                    <table>
                                        <thead>
                                            <tr>
                                                <th class="tm_width_4 tm_semi_bold tm_accent_color tm_accent_bg_10">SL
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($order->order_details as $key => $order_detail)
                                                <tr>
                                                    <td class="tm_width_4 tm_accent_border_20">{{ $key + 1 }}.
                                                    </td>
                                                    <td class="tm_width_5 tm_accent_border_20">
                                                        ...
                                                        @if ($order_detail->is_varient == 1)
                                                            (@if ($order->order_type == 1)
                                                                @php
                                                                    $product = \App\Models\OrderDetail::where(
                                                                        'id',
                                                                        $order_detail->id,
                                                                    )->first();
                                                                    ...
                                                                    if (is_array($data)) {
                                                                        ...
                                                                        // fallback if variation is not JSON array
                                                    ...
                                                    <td class="tm_width_1 tm_accent_border_20"
                                                        style="text-align: center">{{ $order_detail->qty ?? '' }}</td>
                                                    </td>
                            ...
                            <div class="tm_invoice_footer tm_mb15 tm_m0_md">
                                <div class="tm_left_footer">
                                    ...
                                    <p class="tm_m0">Payment Status: {{ $order->payment_status ? 'Paid' : 'Unpaid' }}
                                    </p>
                                </div>
