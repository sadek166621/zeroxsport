...
{{--                            <img src="{{ asset('upload/no_image.jpg') }}" alt="{{ env('APP_NAME') }}" style="max-width: 200px !important;">--}}
                ...
                <td width="120px">
                    ...
                    <div class="tm_shape_bg tm_accent_bg_10 tm_border tm_accent_border_20" style="width: 45%"></div>
                </td>
    ...
    <table width="600px">
        ...
        <tr style="padding-top: 100px">
            ...
            <td align="right" style="padding-left: 100px">
                ...
                @endphp
                @if($logo != null)
                        <img src="data:image/png;base64,{{base64_encode(file_get_contents(base_path('public/'.get_setting('site_favicon')->value)))}} "  alt="{{ env('APP_NAME') }}">
