            ...
            <div class="col-lg-6">
                <ul class="breadcrumb bg-transparent p-0 justify-content-center justify-content-lg-end">
                    ...
                    <li class="text-dark fw-600 breadcrumb-item">
                        <a class="text-reset" href="{{ route('compare.reset') }}">Compare</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <table class="table table-responsive table-bordered mb-0">
                                ...
                                <tr>
                                    ...
                                    @foreach (Session::get('compare') as $key => $item)
                                        <th scope="col" style="width:28%" class="font-weight-bold">
                                            <a class="text-reset fs-15" href="{{ route('product', \App\Models\Product::find($item)->slug) }}">{{ \App\Models\Product::find($item)->name_en }}</a>
                                        </th>
                                    @endforeach
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    @foreach (Session::get('compare') as $key => $item)
                                        <td>
                                            <img loading="lazy" src="{{ asset(\App\Models\Product::find($item)->thumbnail_img) }}" alt="Product Image" class="img-fluid py-4">
                                        </td>
                                    @endforeach
                                </tr>
                                <tr>
