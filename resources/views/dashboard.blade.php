                ...
                <div class="col-lg-9">
                    <div class="dashboard-content">
                        <div class="tab-content">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="action-buttons">
                                                                ...
                                                                @if ($order->delivery_status === 4 && !$order->returnRequest)
                            ...
                            <div class="tab-pane fade" id="return_request">
                                <div class="content-header">
                                    <h2>Return Requests</h2>
                                    <p>Track your product return status</p>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table custom-table">
                                        ...
                                        <tbody>
                                            @forelse ($return_requests as $key => $request)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
