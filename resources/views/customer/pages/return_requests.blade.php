...
@section('content')
    <div class="container">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    <div class="filter-card rejected">
                        ...
                        <div class="filter-info">
                            <div class="filter-value">{{ count($rejected) }}</div>
                ...
                <div class="col-md-3">
                    <div class="filter-card approved">
                        ...
                        <div class="filter-info">
                            <div class="filter-value">{{ count($approved) }}</div>
                ...
                {{-- Returned --}}
                <div class="col-md-3">
                    <div class="filter-card returned">
                        <div class="filter-icon">
                            <i class="fas fa-undo-alt"></i>
                        </div>
                        <div class="filter-info">
                            <div class="filter-value">{{ count($return) }}</div>
                            <div class="filter-label">Returned</div>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @forelse ($requests as $key => $request)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>#{{ $request->order->invoice_no ?? 'N/A' }}</td>
        ...
        <div id="request_details" class="mt-4"></div>
    </div>
@endsection
<style>
    :root {
...
@push('scripts')
    ...
    <script>
        function getDetails(id) {
            $.ajax({
                type: 'GET',
                url: "{{ url('/get-returning-product') }}/" + id,
                dataType: 'json',
                success: function(data) {
                    ...
                    <div class="card mt-4">
                        ...
                        <tr>
                            ...
                            <td>${item.qty}</td>
                            <td>${item.issue}</td>
                            <td>${item.status == 1 ? 'Replaced' : 'Not Replaced'}</td>
                        </tr>`;
                        });
