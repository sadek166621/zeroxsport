                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb-cart d-flex  align-items-center mb-0">
                            <li class="breadcrumb-item">
                                <a href="{{ route('wholeseller.dashboard') }}" style="color: #28a745; text-decoration: none;">
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="cart-container shadow-sm"
                    ...
                    <div style="padding: 28px;" id="cartPage">
                ...
                <div class="summary-card shadow-sm"
                    ...
                    <div class="summary-body" style="padding: 22px 20px;">
                        ...
                        <div class="checkout-actions text-end mt-3">
                            @if (Auth::check())
                                <a href="{{ route('wholeseller.checkout') }}" class="btn btn-lg py-3 px-4 block w-100"
                            ...
                            rows += `
                                                                   ...
                                                                   <div class="col-md-2 col-4 text-md-center mb-2 mb-md-0">
                                                                       <div class="quantity-control mx-auto" style="display: flex; align-items: center; background: #fff; border-radius: 30px; padding: 2px 8px; width: fit-content; border: 1px solid #e0e0e0;">
                                                                           ${value.qty > 1
                               ? `<button type="button" class="qty-btn qty-btn-minus" id="${value.rowId}" onclick="cartDecrement(this.id)" style="width: 25px; height: 25px; border-radius: 50%; border: none; background: #e9ecef; color: #28a745; font-weight: bold;">
                               ...
                               : `<button type="button" class="qty-btn qty-btn-minus" disabled style="width: 32px; height: 32px; border-radius: 50%; border: none; background: #f5f5f5; color: #ccc;">
                                                                           ...
                                                                           <button type="button" class="qty-btn qty-btn-plus" id="${value.rowId}" onclick="cartIncrement(this.id)" style="width: 25px; height: 25px; border-radius: 50%; border: none; background: #28a745; color: #fff; font-weight: bold;">
