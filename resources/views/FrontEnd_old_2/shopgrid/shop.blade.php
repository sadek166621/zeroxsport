        ...
        <div class="col-lg-9 order-first order-lg-last">
          ...
          <div class="box-filters mt-0 pb-5 border-bottom">
            <div class="row">
              ...
              <div class="col-xl-10 col-lg-9 mb-10 text-lg-end text-center"><span class="font-sm color-gray-900 font-medium border-1-right span">We Found {{ count($products)}} Products</span>
                ...
                <div class="card-grid-style-3">
                    <div class="card-grid-inner">
                      ...
                      <div class="info-right"><a class="font-xs color-gray-500" href="shop-vendor-single.html">{{ $product->category->name_en }}</a>
                        <br>
                        <a class="color-brand-3 font-sm-bold" href="{{ route('product.details',$product->slug) }}">{!! Str::substr($product->name_en , 0, 25) !!}..</a>
                        ...
                        @if ($product->discount_price > 0)
                            <strong class="font-lg-bold color-brand-3 price-main">{{ $product->discount_price }}</strong>
                            <span class="color-gray-500 price-line">{{ $product->regular_price }}</span>
                        </div>
                        @else
                        <span class="color-gray-500 price-line">{{ $product->regular_price }}</span>
