            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                ...
                <div class="card-grid-style-3">
                    <div class="card-grid-inner">
                      ...
                      <div class="image-box"><span class="label bg-brand-2"></span>
                      ...
                      <div class="info-right"><a class="font-xs color-gray-500" href="#">@if(session()->get('language') == 'bangla')
                        {{ $product->category->name_bn }}
                    @else
                    {{ $product->category->name_en }}
                    @endif</a>
                        <br>
                        <a class="color-brand-3 font-sm-bold" href="{{ route('product.details',$product->slug) }}">@if(session()->get('language') == 'bangla')
                            {{ $product->name_bn }}
                        @else
                        {{ $product->name_en }}
                        @endif</a>
