...
Route::middleware('adminAccess')->group(function () {
    ...
    Route::get('/customer/{id}/reset-password', [UserController::class, 'resetPassword'])->name('reset-password');
    Route::post('/customer/{id}/reset-password-store', [UserController::class, 'resetPasswordStore'])->name('reset-password.store');
